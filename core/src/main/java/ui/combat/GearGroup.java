...
public class GearGroup extends Group {
    ...
    private void setUpItemSlots() {
        ...
        itemSlots[1] = new ItemSlot(115, 85, new Item("A", "B", items[2][1]), sr);
        itemSlots[2] = new ItemSlot(115, 150, new Item("A", "B", items[5][1]), sr);
        itemSlots[3] = new ItemSlot(50, 20, new Item("A", "B", items[1][1]), sr);
        itemSlots[4] = new ItemSlot(180, 20, new Item("A", "B", items[4][1]), sr);
        itemSlots[5] = new ItemSlot(50, 130, new Item("A", "B", items[0][8]), sr);
        itemSlots[6] = new ItemSlot(180, 130, new Item("A", "B", items[0][9]), sr);
